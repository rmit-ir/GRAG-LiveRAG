...
class ReRankLogitsRAG(RAGSystemInterface):
    ...
    def process_question(self, question: str, qid: str = None) -> RAGResult:
        ...
        for query in queries:
            embed_results = self.query_service.query_embedding(query, k=6)
            keyword_results = self.query_service.query_keywords(query, k=6)
...
if __name__ == "__main__":
    ...
    rag_system = ReRankLogitsRAG(use_rerank=False)
